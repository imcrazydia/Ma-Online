...
<nav x-data="{ open: false }" class="bg-ma-dark-gray border-bottom-white">
                ...
                <div class="flex-shrink-0 flex items-center">
                    <a href="{{ route('home') }}">
                        <img src="https://i.ibb.co/FHTDTKx/logo-ma-online.png" class="h-8 relative image-center inline"
                             alt="alt text">
                        <a href="/" class="text-white font-normal text-2xl pl-4 pt-1">
                            Ma Online
                        </a>
                    </a>
                </div>
                    ...
                    <a href="{{ route('upload') }}">
                        <div class="upload-button-container ml-4">
                            <div
                                ...
                                <div class="upload-icon"><i class="fas fa-upload absolute upload-button-inner"></i>
                                </div>
                            </div>
                    </a>
            </div>
        ...
        <!-- Settings Dropdown -->
            <div class="ml-3 relative">
                <x-jet-dropdown align="right" width="48">
                    <x-slot name="trigger">
                        @if (Laravel\Jetstream\Jetstream::managesProfilePhotos())
                            <button
                                ...
                                <div
                                    class="fold-out absolute text-white bg-magenta-100 hover:bg-lightgreen-100 transition-all">
                        ...
                        @else
                            <span class="inline-flex rounded-md">
                                    <button type="button"
                                            class="inline-flex items-center px-3 py-2 border border-transparent text-sm
                                            leading-4 font-medium rounded-md text-white bg-magenta hover:text-white-700
                    ...
                    <x-slot name="content">
                        <!-- Account Management -->
                        <div class="block px-4 py-2 text-xs text-white font-semibold">
                            {{ __('Beheer account') }}
                        </div>
    ...
    <div :class="{'block': open, 'hidden': ! open}" class="hidden sm:hidden">
        ...
        <div class="pt-4 pb-1 border-t border-gray-200">
            <div class="flex items-center px-4">
                @if (Laravel\Jetstream\Jetstream::managesProfilePhotos())
                    <div class="flex-shrink-0 mobile-nav mr-3">
                        <img class="h-10 w-10 rounded-full object-cover" src="{{ Auth::user()->profile_photo_path }}"
                             alt="{{ Auth::user()->name }}"/>
                    </div>
                @endif
