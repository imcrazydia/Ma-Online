              ...
              <form action="{{ route('store_video') }}" method="POST">
                @csrf
                  ...
                  <div class="px-4 py-3 text-right sm:px-6">
                    <button type="submit" class="bg-magenta inline-flex justify-center py-2 px-4 border border-transparent shadow-sm text-sm font-medium rounded-md text-white focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-indigo-500">
                      Upload
                    </button>
                  </div>
              </form>
